                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="email_address" id="email_address" value="" required data-valid-label="Email Address" minlength="1">
                    </div>
                    <div class="form-group">
                      <label>Address</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="phone_number" id="phone_number" value="" required data-valid-label="Phone Number" minlength="1">
                    </div>
                    <div class="form-group">
                      <label>Company</label>

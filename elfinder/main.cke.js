...
(function(){
	var // jQuery and jQueryUI version
		...
		opts = {
			url : 'http://locahost/jasaseo-id/admin/file_manager/connect', // connector URL (REQUIRED)
			lang: lang,                        // auto detected language (optional)
			getFileCallback : function(file) {
				window.opener.CKEDITOR.tools.callFunction(getUrlParam('CKEditorFuncNum'), file.url);
				elf.destroy();
				window.close();
			},
			resizable: false

...
(function(){
            ...
            $(function() {
                var elfNode, elfInsrance, dialogName,
                    ...
                    elfDirHashMap = { // Dialog name / elFinder holder hash Map
                        image : 'l1_Q0tFX0ltZ3M', // for example to 1st LocalFileVolume : `/CKE_Imgs`
                        flash : '',
                        files : '',
                        link  : '',
                ...
                CKEDITOR.replace('mytextarea', {
                    ...
                    filebrowserUploadUrl: 'http://locahost/kuromatour/admin/file_manager/connect',
                    imageUploadUrl: 'http://locahost/kuromatour/admin/file_manager/connect'
                });
    ...
    require.config({
        baseUrl : 'js',
        paths : {
            'ckeditor' : '//cdnjs.cloudflare.com/ajax/libs/ckeditor/4.6.2/ckeditor',
